    ...
    <div class="container-fluid py-4">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-header bg-white">
                <ul class="nav nav-tabs card-header-tabs mb-0" role="tablist" id="mainTabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#semua" data-tab="semua">
                            <i class="bi bi-list-ul me-1"></i>Semua Lowongan
                            <span class="badge bg-secondary" id="badgeSemua">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#pelamar" data-tab="pelamar">
                            <i class="bi bi-envelope me-1"></i>Via Undangan
                            <span class="badge bg-secondary" id="badgePelamar">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#belum-diproses" data-tab="pending">
                            <i class="bi bi-hourglass me-1"></i>Belum Diproses
                            <span class="badge bg-warning" id="badgePending">0</span>
                        </a>
                    </li>
                    <!-- ✅ TAB BARU: Belum Interview -->
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#belum-interview" data-tab="notInterviewed">
                            <i class="bi bi-camera-video-off me-1"></i>Belum Interview
                            <span class="badge bg-secondary" id="badgeNotInterviewed">0</span>
                        </a>
                    </li>

                    <!-- ✅ TAB BARU: Telah Interview -->
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#telah-interview" data-tab="interviewed">
                            <i class="bi bi-camera-video me-1"></i>Telah Interview
                            <span class="badge bg-primary" id="badgeInterviewed">0</span>
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#diterima" data-tab="accepted">
                            <i class="bi bi-check-circle me-1"></i>Diterima
                            <span class="badge bg-success" id="badgeDiterima">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#ditolak" data-tab="rejected">
                            <i class="bi bi-x-circle me-1"></i>Ditolak
                            <span class="badge bg-danger" id="badgeDitolak">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#finished" data-tab="finished">
                            <i class="bi bi-flag-fill me-1"></i>Selesai
                            <span class="badge bg-info" id="badgeFinished">0</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#withdrawn" data-tab="withdrawn">
                            <i class="bi bi-box-arrow-left me-1"></i>Mengundurkan Diri
                            <span class="badge bg-dark" id="badgeWithdrawn">0</span>
                        </a>
                    </li>
                </ul>
            </div>
...
{{-- <script>
    $(document).ready(function() {
        ...
        function renderPendingTable(response) {
            ...
            `;
                ...
                data.forEach(app => {
                    ...
                    html += `
                    <tr class="fade-in candidate-row" data-application-id="${app.id}" style="cursor: pointer;">
                        <td>
                            <div class="d-flex align-items-center">
                                <img src="${photoUrl}" class="rounded-circle me-3" 
                                    width="45" height="45" style="object-fit: cover; border: 2px solid #e9ecef;">
        ...
        $('#mainTabs a[data-bs-toggle="tab"]').on('shown.bs.tab', function(e) {
            ...
            const loadFunctions = {
                semua: () => loadAllJobs(state.currentPage.semua),
                pelamar: () => loadInvitedApplicants(state.currentPage.pelamar),
                pending: () => loadPendingApplicants(state.currentPage.pending),
                accepted: () => loadAcceptedApplicants(state.currentPage.accepted),
                rejected: () => loadRejectedApplicants(state.currentPage.rejected),
                finished: () => loadFinishedApplicants(state.currentPage.finished) // ✅ TAMBAH INI
            };

            if (loadFunctions[tab]) loadFunctions[tab]();
        });
