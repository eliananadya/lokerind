...
class SkillsPolicy
{
    ...
    {
        return $user->can('force_delete_skills');
    }
    ...
    {
        return $user->can('force_delete_any_skills');
    }
    ...
    {
        return $user->can('restore_skills');
    }
    ...
    {
        return $user->can('restore_any_skills');
    }
    ...
    {
        return $user->can('replicate_skills');
    }
    ...
    {
        return $user->can('reorder_skills');
    }
}
