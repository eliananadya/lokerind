...
class PortofoliosPolicy
{
     ...
     */
    public function view(User $user, Portofolios $portofolios): bool
    {
     ...
     */
    public function update(User $user, Portofolios $portofolios): bool
    {
     ...
     */
    public function delete(User $user, Portofolios $portofolios): bool
    {
     ...
     */
    public function forceDelete(User $user, Portofolios $portofolios): bool
    {
     ...
     */
    public function restore(User $user, Portofolios $portofolios): bool
    {
     ...
     */
    public function replicate(User $user, Portofolios $portofolios): bool
    {
